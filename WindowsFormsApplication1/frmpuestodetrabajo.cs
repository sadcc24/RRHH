...
namespace WindowsFormsApplication1
{
    public partial class Nuevo_Puesto : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            pr.StartInfo.FileName = "Ayuda Nuevo Puesto.pdf";
            pr.Start();
        }
        ...
        {
            if (clr.insertarPuesto(this.txtidpuesto.Text, this.txtempresa.Text, this.txtdepartamento.Text, this.txtnombrepuesto.Text, this.txtestadopuesto.Text))
